...
<a href="https://www.seconexpo.com/2026/kor/main.asp"><img src="../../img/SECON2026.jpg" alt="SECON 2026" /></a><br/>**[SECON 2026](https://www.seconexpo.com/2026/kor/main.asp)** - 국제 보안 전시회에서 만나요!<br/>📅 2026년 3월 18-20일 &nbsp;|&nbsp; 📍 킨텍스 &nbsp;|&nbsp; 🏢 [TS-Solution 부스](https://exhibitors.informamarkets-info.com/event/2026SEC/en-US/exhibitor/470637/ts-solution-co---ltd)
...
#### v3.1.7 출시 (2026.1.15)🎉
1. 한국 5문자 임시번호판 규격 지원

#### v3.1.6 출시 (2025.12.10)🎉
1. 한국 번호판 인식률 향상
2. v3.1.5에서 특정 조건에서 크래시 발생 가능성 수정
   - *v3.1.5는 폐기함* 
